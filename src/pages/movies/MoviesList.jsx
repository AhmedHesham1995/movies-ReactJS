            ...
            <Row xs={2} md={3} className="g-4 ">
                ...
                <Card style={{backgroundColor:'black', color:'gray',border:'1px solid gray'}} className='hov'>
                    ...
                    <span style={{cursor:'pointer'}}>
                        ...
                        <FaHeart className='heart' color="red" size={24} onClick={()=> removefav(movie)} />
                            ...
                            <Card.Title className='details' style={{fontSize:'16px',fontStyle:'italic'}}   >Details: {movie.overview.split("").slice(0,65).join("")}...</Card.Title>
                            {/* <Card.Title>Date: {movie.release_date}</Card.Title> */}

                            <span> <button className="btn btn-danger details "onClick={()=>{navigate(`/details/${movie.id}`) }}
                                >Details</button>
                            </span>
                    </Card.Body>
                </Card>
...
// const MoviesList = ({ theme, toggleTheme }) => {
//   const [movies, setMovies] = useState([]);
//   const [currentPage, setCurrentPage] = useState(1);
//   const navigate = useNavigate();
//   const favMovie = useSelector((state) => state.favroites);
//   const dispatch = useDispatch();
...
//         </button>
//       </div>
//       <div style={{ backgroundColor: theme === 'dark' ? 'black' : 'white' }} className='pt-5 '>
//         <div className='container'>
//           <Row xs={2} md={3} className="g-4 ">
//             {movies ? (movies.map((movie) => (
//               <Col key={movie.id}>
...
//           </Row>
//           <div className='d-flex justify-content-around mt-3 pb-2'>
//             <button className='btn btn-danger' onClick={() => { setCurrentPage(currentPage - 1); }}>previous</button>
//             <button className='btn btn-danger' onClick={() => { setCurrentPage(currentPage + 1); }}>Next</button>
//           </div>
//         </div>
//       </div>
//     </>
